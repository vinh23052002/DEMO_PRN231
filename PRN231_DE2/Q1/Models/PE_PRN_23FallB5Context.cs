...
namespace Q1.Models
{
    public partial class PE_PRN_23FallB5Context : DbContext
    {
        public PE_PRN_23FallB5Context()
        {
        }

        public PE_PRN_23FallB5Context(DbContextOptions<PE_PRN_23FallB5Context> options)
            : base(options)
        {
        }
