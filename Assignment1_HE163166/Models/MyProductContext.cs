...
{
    public partial class MyProductContext : DbContext
    {
        public MyProductContext()
        {
        }

        public MyProductContext(DbContextOptions<MyProductContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.ShipperDate).HasColumnType("date");
